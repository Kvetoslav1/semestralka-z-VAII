...
if(isset($_POST['post'], $pripojenie)) {
    $vyberanie->pridajOdpoved($pripojenie, $_POST['post'], $nazovPostu);
}
...
<script>
    window.onload = strankovanie(1, '<?php echo $nazovPostu ?>');
</script>

<body style="grid-template-rows: [row1-start] 1% [row2-start] 230vh [row3-start] 1%">
...
<div class="telo">
    ...
    <div class="odsadenie">
        ...
        <div id="gridPosty" class="gridy">
            ...
            <textarea class="post-area" readonly disabled>
            ...
            <div id="komentare" style="grid-row: 4; padding-left: 5%">

            </div>
            <div id="cisla" style="grid-row: 5; text-align: center;">
